...
The R programming language [@R]  and the following R packages were used to conduct our analysis: repr [@repr], tidyverse [@Wickham2017], tidymodels [@Kuhn2023], psych [@Revelle2019], GGally [@Schloerke2020].
