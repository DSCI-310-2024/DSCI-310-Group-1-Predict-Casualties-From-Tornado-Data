...
data/processed/01_processed_tornado_data.csv data/processed/02_tornado_train_data.csv data/processed/03_tornado_test_data.csv data/processed/04_tornado_outlierless.csv data/processed/05_tornado_train_outlierless.csv data/processed/06_tornado_test_outlierless.csv: src/02_clean_preprocess_data.R data/raw/raw_tornado_data.csv
	...
	--out_file=data/processed/01_processed_tornado_data.csv data/processed/02_tornado_train_data.csv data/processed/03_tornado_test_data.csv data/processed/04_tornado_outlierless.csv data/processed/05_tornado_train_outlierless.csv data/processed/06_tornado_test_outlierless.csv
...
results/02_linear_model_test_scores.csv results/03_actual_vs_predicted_fatalities_plot.png results/04_fatalities_vs_width_plot.png results/05_fatalities_vs_length_plot.png results/06_width_outliers_boxplot.png results/07_length_outliers_boxplot.png results/08_fatalities_outliers_boxplot.png results/09_linear_model_test_scores_without_outliers.csv results/10_actual_vs_predicted_fatalities_no_outliers.png results/11_fatalities_vs_width_plot_no_outliers.png results/12_fatalities_vs_length_plot_no_outliers.png: src/05_linear_model_results.R data/processed/03_tornado_test_data.csv results/01_linear_model.rds
	...
	--train_outlierless=data/processed/05_tornado_train_outlierless.csv \
	--test_outlierless=data/processed/06_tornado_test_outlierless.csv \
