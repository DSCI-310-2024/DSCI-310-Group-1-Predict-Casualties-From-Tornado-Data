...
# render report
report: report/tornado_fatalities_predictor.qmd \
	report/tornado_fatalities_predictor.html \
	report/tornado_fatalities_predictor.pdf 

report/tornado_fatalities_predictor.qmd: data/processed/01_processed_tornado_data.csv data/processed/02_tornado_train_data.csv data/processed/03_tornado_test_data.csv data/processed/04_tornado_outlierless.csv data/processed/05_tornado_train_outlierless.csv data/processed/06_tornado_test_outlierless.csv: src/02_clean_preprocess_data.R data/raw/raw_tornado_data.csv \
	results 
